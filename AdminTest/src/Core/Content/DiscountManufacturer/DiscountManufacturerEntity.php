...
namespace AdminTest\Core\Content\DiscountManufacturer;
...
#[EntityAttribute('discount_manufacturer')]
class DiscountManufacturerEntity extends Entity
{
    #[PrimaryKey]
...
/*    #[Field(type: FieldType::STRING, api: [AdminApiSource::class])]
    ...
    #[ForeignKey(entity: 'custom_field', api: [AdminApiSource::class])]
    public ?string $priceReferenceId = null;

    #[ManytoOne(entity: 'custom_field', api: [AdminApiSource::class])]
    public ?CustomFieldEntity $priceReference= null;
