...
.mt-field-label[data-v-a8819910] {
  display: flex;
...
.mt-field-label--is-required[data-v-a8819910]::after {
  content: "*";
  color: var(--color-text-brand-default);
}
.mt-field-label--has-linked-inheritance[data-v-a8819910] {
  color: var(--color-text-accent-default);
}
.mt-field-label--with-error[data-v-a8819910] {
...
.mt-button__content[data-v-fb8352b6] {
  display: grid;
  grid-auto-flow: column;
  align-items: center;
  column-gap: var(--scale-size-8);
}
.mt-button__content--hidden[data-v-fb8352b6] {
  visibility: hidden;
}
.mt-button--primary[data-v-fb8352b6] {
  background: var(--color-interaction-primary-default);
  color: var(--color-text-static-default);
  border-color: var(--color-interaction-primary-default);
}
.mt-button--primary .mt-icon[data-v-fb8352b6] {
  color: var(--color-icon-static-default);
}
.mt-button--primary[data-v-fb8352b6]:hover,
.mt-button--primary[data-v-fb8352b6]:focus-visible,
.mt-button--primary[data-v-fb8352b6]:active {
...
.mt-button--primary[data-v-fb8352b6]:disabled,
.mt-button--primary.mt-button--disabled[data-v-fb8352b6] {
  background: var(--color-interaction-primary-disabled);
  border-color: var(--color-interaction-primary-disabled);
  cursor: not-allowed;
}
.mt-button--primary-ghost[data-v-fb8352b6] {
  background: transparent;
  border: 1px solid var(--color-border-brand-selected);
  border-color: var(--color-border-brand-selected);
  color: var(--color-text-brand-default);
}
.mt-button--primary-ghost[data-v-fb8352b6]:is(:hover, :focus-visible, :active) {
  background: var(--color-background-brand-default);
}
.mt-button--primary-ghost[data-v-fb8352b6]:focus-visible {
  box-shadow: 0 0 4px 0 rgba(24, 158, 255, 0.3);
}
.mt-button--primary-ghost[data-v-fb8352b6]:disabled,
.mt-button--primary-ghost.mt-button--disabled[data-v-fb8352b6] {
  color: var(--color-text-brand-disabled);
  border-color: var(--color-border-brand-disabled);
  background: transparent;
}
.mt-button--primary-ghost:disabled .mt-icon[data-v-fb8352b6],
.mt-button--primary-ghost.mt-button--disabled .mt-icon[data-v-fb8352b6] {
  color: var(--color-icon-brand-disabled);
}
.mt-button--primary-ghost .mt-icon[data-v-fb8352b6] {
  color: var(--color-icon-brand-default);
}
.mt-button--secondary[data-v-fb8352b6] {
  background: var(--color-interaction-secondary-default);
  border: 1px solid var(--color-border-primary-default);
  color: var(--color-text-primary-default);
}
.mt-button--secondary[data-v-fb8352b6]:is(:hover, :focus-visible, :active) {
  background: var(--color-interaction-secondary-hover);
}
.mt-button--secondary[data-v-fb8352b6]:focus-visible {
  border-color: var(--color-border-brand-selected);
  box-shadow: 0 0 4px 0 rgba(24, 158, 255, 0.3);
}
.mt-button--secondary[data-v-fb8352b6]:disabled,
.mt-button--secondary.mt-button--disabled[data-v-fb8352b6] {
  color: var(--color-text-primary-disabled);
  background: var(--color-interaction-secondary-disabled);
  cursor: not-allowed;
}
.mt-button--secondary:disabled .mt-icon[data-v-fb8352b6],
.mt-button--secondary.mt-button--disabled .mt-icon[data-v-fb8352b6] {
  color: var(--color-icon-primary-disabled);
}
.mt-button--secondary .mt-icon[data-v-fb8352b6] {
  color: var(--color-icon-primary-default);
}
.mt-button--critical[data-v-fb8352b6] {
  background: var(--color-interaction-critical-default);
  color: var(--color-text-static-default);
  border: 1px solid var(--color-interaction-critical-default);
}
.mt-button--critical[data-v-fb8352b6]:is(:hover, :focus-visible, :active) {
  background: var(--color-interaction-critical-hover);
  border-color: var(--color-interaction-critical-hover);
}
.mt-button--critical[data-v-fb8352b6]:focus-visible {
  border-color: var(--color-border-brand-selected);
  box-shadow: 0 0 4px 0 rgba(24, 158, 255, 0.3);
}
.mt-button--critical[data-v-fb8352b6]:disabled,
.mt-button--critical.mt-button--disabled[data-v-fb8352b6] {
  background: var(--color-interaction-critical-disabled);
  border-color: var(--color-interaction-critical-disabled);
}
.mt-button--critical:disabled .mt-icon[data-v-fb8352b6],
.mt-button--critical.mt-button--disabled .mt-icon[data-v-fb8352b6],
.mt-button--critical .mt-icon[data-v-fb8352b6] {
  color: var(--color-icon-static-default);
}
.mt-button--critical-ghost[data-v-fb8352b6] {
  background: transparent;
  border: 1px solid var(--color-border-critical-default);
  color: var(--color-text-critical-default);
}
.mt-button--critical-ghost[data-v-fb8352b6]:is(:hover, :focus-visible, :active) {
  background-color: var(--color-background-critical-dark);
}
.mt-button--critical-ghost[data-v-fb8352b6]:focus-visible {
  border-color: var(--color-border-brand-selected);
  box-shadow: 0 0 4px 0 rgba(255, 0, 0, 0.3);
}
.mt-button--critical-ghost[data-v-fb8352b6]:disabled,
.mt-button--critical-ghost.mt-button--disabled[data-v-fb8352b6] {
  color: var(--color-text-critical-disabled);
  border-color: var(--color-border-critical-disabled);
}
.mt-button--critical-ghost:disabled .mt-icon[data-v-fb8352b6],
.mt-button--critical-ghost.mt-button--disabled .mt-icon[data-v-fb8352b6] {
  color: var(--color-icon-critical-disabled);
}
.mt-button--critical-ghost .mt-icon[data-v-fb8352b6] {
  color: var(--color-icon-critical-default);
}
.mt-button--action[data-v-fb8352b6] {
  border: 1px solid #e2e8f0;
  background-color: #ffffff;
  color: #000000;
}
.mt-button--action .mt-icon[data-v-fb8352b6] {
  color: #1a202c;
}
.mt-button--action[data-v-fb8352b6]:hover {
  background-color: #edf2f7;
  color: #4a5568;
}
.mt-button--action[data-v-fb8352b6]:disabled {
  background-color: #f7fafc;
  color: #a0aec0;
}
.mt-button--block[data-v-fb8352b6] {
  display: block;
  width: 100%;
  display: flex;
  justify-content: center;
...
.mt-button--x-small[data-v-fb8352b6] {
  padding-left: var(--scale-size-10);
  padding-right: var(--scale-size-10);
  font-size: var(--font-size-2xs);
  min-height: 24px;
}
.mt-button--x-small.mt-button--square[data-v-fb8352b6] {
  width: var(--scale-size-24);
  height: var(--scale-size-24);
}
.mt-button--small[data-v-fb8352b6] {
  padding-left: 15px;
  padding-right: 15px;
  font-size: var(--font-size-2xs);
  min-height: 32px;
}
.mt-button--small.mt-button--square[data-v-fb8352b6] {
  width: var(--scale-size-32);
  height: var(--scale-size-32);
}
.mt-button--default[data-v-fb8352b6] {
  padding-inline: var(--scale-size-16);
  font-size: var(--font-size-xs);
  min-height: 2.5rem;
}
.mt-button--default.mt-button-square[data-v-fb8352b6] {
  width: var(--scale-size-40);
  height: var(--scale-size-40);
}
.mt-button--large[data-v-fb8352b6] {
  padding-left: var(--scale-size-28);
  padding-right: var(--scale-size-28);
  min-height: 3rem;
  font-size: var(--font-size-2xs);
}
.mt-button--large.mt-button--square[data-v-fb8352b6] {
  width: var(--scale-size-48);
  height: var(--scale-size-48);
}
.mt-button--square[data-v-fb8352b6] {
  width: var(--scale-size-40);
  height: var(--scale-size-40);
  padding-left: 0;
  padding-right: 0;
...
.mt-button--square .mt-button__content[data-v-fb8352b6] {
  display: inline;
}
.mt-button__loader[data-v-fb8352b6] {
  border-radius: var(--border-radius-xs);
}

.tooltip[data-v-af6b994c] {
...
.mt-tooltip__content ul[data-v-af6b994c] {
  list-style-position: inside;
}
.v-enter-active[data-v-af6b994c],
.v-leave-active[data-v-af6b994c] {
...
.v-enter-from[data-v-af6b994c],
.v-leave-to[data-v-af6b994c] {
  opacity: 0;
}
.v-enter-from[data-placement="top"][data-v-af6b994c],
.v-leave-to[data-placement="top"][data-v-af6b994c] {
  margin-bottom: var(--scale-size-5);
}
.v-enter-from[data-placement="bottom"][data-v-af6b994c],
.v-leave-to[data-placement="bottom"][data-v-af6b994c] {
  margin-top: var(--scale-size-5);
}
.v-enter-from[data-placement="left"][data-v-af6b994c],
.v-leave-to[data-placement="left"][data-v-af6b994c] {
  margin-right: var(--scale-size-5);
}
.v-enter-from[data-placement="right"][data-v-af6b994c],
.v-leave-to[data-placement="right"][data-v-af6b994c] {
  margin-left: var(--scale-size-5);
}

.mt-inheritance-switch[data-v-e42fb103] {
  cursor: pointer;
  margin-top: -1px;
...
.mt-inheritance-switch--disabled[data-v-e42fb103] {
  cursor: default;
}

.mt-field-copyable[data-v-014f620f] {
  cursor: pointer;
}
...
&[data-v-7ef3eb14]:focus-visible {
    outline-offset: 0.25rem;
    outline: 2px solid var(--color-border-brand-selected);
}
&[data-v-7ef3eb14]:where(:hover, :focus-visible) {
    color: var(--color-icon-brand-hover);
}
}
.mt-help-text[data-v-7ef3eb14]::after {
  content: "";
  display: block;
  position: absolute;
  inset: 0;
...
.mt-help-text__tooltip-text[data-v-7ef3eb14] {
  display: none;
}
...
.mt-email-field[data-v-fb1c76d9] {
  display: grid;
  grid-template-areas:
    "label help-text"
    "input input"
...
.mt-email-field--future-no-default-margin[data-v-fb1c76d9] {
  margin-bottom: 0;
}
...
&[data-v-fb1c76d9] ::placeholder {
    color: var(--color-text-secondary-default);
}
&:not(.mt-email-field__block--error)&[data-v-fb1c76d9]:has(.mt-email-field__input:focus-visible) {
    border-color: var(--color-border-brand-selected);
    box-shadow: 0px 0px 4px 0px rgba(24, 158, 255, 0.3);
}
...
.mt-email-field__block--error[data-v-fb1c76d9] {
  border-color: var(--color-border-critical-default);
  background-color: var(--color-background-critical-dark);
}
.mt-email-field__input[data-v-fb1c76d9] {
  -webkit-appearance: none;
  -moz-appearance: none;
  appearance: none;
...
&[data-v-fb1c76d9]:is(:hover, :focus-visible) {
    background-color: var(--color-interaction-secondary-hover);
}
&[data-v-fb1c76d9]:focus-visible {
    outline: 2px solid var(--color-border-brand-selected);
}
}
.mt-email-field__hint[data-v-fb1c76d9] {
  font-family: var(--font-family-body);
  font-size: var(--font-size-xs);
  line-height: var(--font-line-height-xs);
  color: var(--color-text-tertiary-default);
...
.mt-email-field__block--small[data-v-fb1c76d9] {
...
&[data-v-71cd9494]:focus-visible {
    outline-offset: 2px;
    outline: 2px solid var(--color-border-brand-selected);
    border-radius: var(--border-radius-xs);
}
}
.mt-link[data-v-71cd9494]:is(:disabled, .mt-link--disabled) {
  cursor: not-allowed;
}
.mt-link--primary[data-v-71cd9494] {
  color: var(--color-text-brand-default);
}
.mt-link--primary[data-v-71cd9494]:is(:hover, :active) {
  color: var(--color-text-brand-hover);
}
.mt-link--primary[data-v-71cd9494]:is(:disabled, .mt-link--disabled) {
  color: var(--color-text-brand-disabled);
}
.mt-link--critical[data-v-71cd9494] {
  color: var(--color-text-critical-default);
}
.mt-link--critical[data-v-71cd9494]:is(:hover, :active) {
  color: var(--color-text-critical-hover);
}
.mt-link--critical[data-v-71cd9494]:is(:disabled, .mt-link--disabled) {
  color: var(--color-text-critical-disabled);
}
...
&[data-v-3cf1ed68]:is(:hover, :focus-visible) {
      background-color: var(--color-interaction-secondary-hover);
}
&[data-v-3cf1ed68]:disabled {
      cursor: default;
}
}
}
input.mt-number-field__align-end[data-v-3cf1ed68] {
  text-align: end;
}
...
.mt-password-field[data-v-43e064fb] {
  width: 100%;
}
...
&:not(.mt-password-field__block--error)&[data-v-43e064fb]:has(.mt-password-field__input:focus-visible) {
    border-color: var(--color-border-brand-selected);
    box-shadow: 0px 0px 4px 0px rgba(24, 158, 255, 0.3);
}
&[data-v-43e064fb]:has(input:disabled) {
    background-color: var(--color-background-primary-disabled);
}
}
.mt-password-field__block--error[data-v-43e064fb] {
  border-color: var(--color-border-critical-default);
...
&[data-v-43e064fb]:is(:hover, :focus-visible) {
    background-color: var(--color-interaction-secondary-hover);
}
&[data-v-43e064fb]:focus-visible {
    outline: 2px solid var(--color-border-brand-selected);
}
}
...
&:not(:has(.mt-card__tabs:empty)) .mt-card__header[data-v-63ec72db] {
    border-bottom: none;
}
}
.mt-card--future-remove-default-margin[data-v-63ec72db] {
  margin-block-end: 0;
}
.mt-card__content {
&[data-v-63ec72db] {
...
&[data-v-63ec72db] > :where(h1, h2, h3, h4, h5, h6) {
    font-weight: normal;
}
& > h1[data-v-63ec72db] {
    font-size: 1.5rem;
...
&[data-v-63ec72db] > :where(h4, h5, h6) {
    font-size: 1.125rem;
}
...
&[data-v-63ec72db]:hover {
      color: var(--color-text-brand-hover);
}
}
}
.mt-card--has-footer {
& .mt-card__content[data-v-63ec72db] {
    border: none;
...
& .mt-card__title[data-v-63ec72db],
  & .mt-card__subtitle[data-v-63ec72db] {
    width: auto;
    position: relative;
    top: 0;
    left: 0;
...
.mt-card--future-ignore-max-width[data-v-63ec72db] {
  max-width: none;
  margin-inline: 0;
}
.mt-card__titles[data-v-63ec72db] {
  display: flex;
  flex-direction: column;
  justify-content: space-between;
}
...
& .mt-card__inheritance-toggle[data-v-63ec72db] {
    color: var(--color-icon-accent-default);
}
}
.mt-card--grid {
...
& .mt-grid[data-v-63ec72db] {
      border-top: none;
}
}
}
.mt-card__header[data-v-63ec72db] {
  display: flex;
  flex-wrap: wrap;
  align-items: stretch;
...
&[data-v-63ec72db]:focus-visible {
    outline: 2px solid var(--color-border-brand-selected);
    outline-offset: 2px;
    border-radius: var(--border-radius-button);
}
}
.mt-card__titles-right-slot[data-v-63ec72db] {
  color: var(--color-text-primary-default);
  margin-left: auto;
}
.mt-card__footer {
...
.mt-empty-state[data-v-a65a01b2] {
  display: flex;
  flex-direction: column;
  align-items: flex-start;
}
.mt-empty-state__icon[data-v-a65a01b2] {
  display: inline-block;
  padding: var(--scale-size-12);
  border-radius: var(--border-radius-xs);
  background-color: var(--color-interaction-secondary-dark);
}
.mt-empty-state__headline[data-v-a65a01b2] {
  margin-top: var(--scale-size-24);
  margin-bottom: 0;
}
.mt-empty-state__description[data-v-a65a01b2] {
  margin-top: var(--scale-size-8);
}
.mt-empty-state__link[data-v-a65a01b2] {
  margin-top: var(--scale-size-8);
}
.mt-empty-state__button[data-v-a65a01b2] {
  margin-top: var(--scale-size-24);
}

.mt-tabs[data-v-69c866e5] {
  display: flex;
  position: relative;
  box-shadow: inset 0 -1px 0 var(--color-border-primary-default);
}
.mt-tabs--small[data-v-69c866e5] {
  max-width: 800px;
  margin: 0 auto 15px auto;
}
.mt-tabs--future-remove-default-margin[data-v-69c866e5] {
  margin-block-end: 0;
}
.mt-tabs--vertical {
&[data-v-69c866e5] {
...
& .mt-tabs__slider[data-v-69c866e5] {
    top: 0;
    bottom: auto;
    left: 3px;
}
...
&[data-v-69c866e5]:disabled {
    cursor: not-allowed;
    color: var(--color-text-primary-disabled);
}
&[data-v-69c866e5]:focus-visible {
    outline: 2px solid var(--color-border-brand-selected);
    outline-offset: 2px;
    border-radius: var(--border-radius-xs);
}
&[data-v-69c866e5]::after {
...
.mt-tabs__item--error[data-v-69c866e5] {
  color: var(--color-text-critical-default);
}
.mt-tabs__item--active[data-v-69c866e5] {
  font-weight: var(--font-weight-medium);
}
.mt-tabs__slider[data-v-69c866e5] {
...
.mt-tabs__slider--error[data-v-69c866e5] {
  background-color: var(--color-border-critical-default);
}
.mt-tabs__slider--animated[data-v-69c866e5] {
...
.mt-tabs__error-badge[data-v-69c866e5] {
...
&[data-v-29a69ac7] :last-child {
    border-top-right-radius: var(--border-radius-xs);
    border-bottom-right-radius: var(--border-radius-xs);
}
&[data-v-29a69ac7] :first-child {
    border-top-left-radius: var(--border-radius-xs);
    border-bottom-left-radius: var(--border-radius-xs);
}
}
.mt-pagination__controls[data-v-29a69ac7] {
  display: inline-flex;
  border-radius: var(--border-radius-xs);
  border: 1px solid var(--color-border-primary-default);
}
.mt-pagination__info-text[data-v-29a69ac7] {
  color: var(--color-text-tertiary-default);
  font-size: var(--font-size-xs);
  line-height: var(--font-line-height-xs);
  font-family: var(--font-family-body);
...
&[data-v-29a69ac7]:focus-visible {
    outline: 1px solid var(--color-border-brand-selected);
    background-color: var(--color-interaction-secondary-hover);
}
&[data-v-29a69ac7]:hover:not(:disabled) {
    background-color: var(--color-interaction-secondary-hover);
}
&[data-v-29a69ac7]:last-of-type {
    border-right: none;
}
&[data-v-29a69ac7]:disabled {
...
&[data-v-29a69ac7]::-webkit-outer-spin-button,
  &[data-v-29a69ac7]::-webkit-inner-spin-button {
    -webkit-appearance: none;
    margin: 0;
}
&[type="number"][data-v-29a69ac7] {
    -moz-appearance: textfield;
}
}
...
.mt-data-table-text-renderer-cell[data-v-29fe96a5] {
  display: flex;
  align-items: center;
}
.mt-data-table-preview-image-renderer[data-v-29fe96a5] {
  position: relative;
  width: 34px;
  height: var(--scale-size-24);
  border: 1px solid var(--color-border-primary-default);
...
img.mt-data-table-preview-image-renderer[data-v-29fe96a5] {
  position: absolute;
  left: 50%;
  top: 50%;
  transform: translate(-50%, -50%);
...
&[data-v-5114689b]:hover,
  &[data-v-5114689b]:focus-visible {
    color: var(--color-text-brand-hover);
    text-decoration: none;
}
}
...
.mt-data-table-filter__property[data-v-6bd5fd64] {
  border: 1px solid var(--color-border-primary-default);
  border-right: 0 none;
  border-top-left-radius: var(--border-radius-xs);
  border-bottom-left-radius: var(--border-radius-xs);
...
.mt-data-table-filter__rule[data-v-6bd5fd64] {
  border-top: 1px solid var(--color-border-primary-default);
  border-bottom: 1px solid var(--color-border-primary-default);
  padding-right: var(--scale-size-4);
}
...
& button[data-v-6bd5fd64] {
    outline: 0 none;
}
&[data-v-6bd5fd64]:has(button:hover) {
    background-color: var(--color-interaction-secondary-hover);
}
&[data-v-6bd5fd64]:has(button:focus-visible) {
    background-color: var(--color-background-brand-default);
...
& .mt-icon[data-v-6bd5fd64] {
    position: absolute;
    top: 50%;
    left: 50%;
    transform: translate(-50%, -50%);
}
&[data-v-6bd5fd64]:focus-visible {
    background-color: var(--color-background-brand-default);
    border-color: var(--color-border-brand-selected);
}
&[data-v-6bd5fd64]:hover {
    background-color: var(--color-interaction-secondary-hover);
}
}
...
.mt-modal--width-s[data-v-b2df9cce] {
  --mt-modal-width: 27.5rem;
}
.mt-modal--width-m[data-v-b2df9cce] {
  --mt-modal-width: 45rem;
}
.mt-modal--width-l[data-v-b2df9cce] {
  --mt-modal-width: 64rem;
}
.mt-modal--width-xl[data-v-b2df9cce] {
  --mt-modal-width: 90rem;
}
.mt-modal--width-full[data-v-b2df9cce] {
  --mt-modal-width: 100%;
}
.modal-enter-active[data-v-b2df9cce] {
...
.modal-leave-active[data-v-b2df9cce] {
...
.modal-enter-from[data-v-b2df9cce],
.modal-leave-to[data-v-b2df9cce] {
  opacity: 0;
@media (prefers-reduced-motion: no-preference) {
    scale: 0.9;
}
}
.mt-modal__title[data-v-b2df9cce] {
  margin-block-end: 0;
}
.mt-modal__content[data-v-b2df9cce] {
  position: relative;
  overflow-y: auto;
}
.mt-modal__content-inner[data-v-b2df9cce] {
  padding: var(--scale-size-24);
}
.mt-modal__content-inner--no-padding[data-v-b2df9cce] {
  padding: 0;
}
.mt-modal__scroll-shadow[data-v-b2df9cce] {
  position: sticky;
  left: 0;
  right: 0;
  height: var(--scale-size-4);
...
.mt-modal__scroll-shadow--top[data-v-b2df9cce] {
  top: 0;
}
.mt-modal__scroll-shadow--bottom[data-v-b2df9cce] {
  bottom: 0;
}
.shadow-fade-enter-active[data-v-b2df9cce] {
  transition: opacity 400ms cubic-bezier(0.05, 0.7, 0.1, 1);
@media (prefers-reduced-motion: no-preference) {
    transition: opacity 400ms cubic-bezier(0.05, 0.7, 0.1, 1);
}
}
.shadow-fade-leave-active[data-v-b2df9cce] {
  transition: opacity 200ms cubic-bezier(0.3, 0, 0.8, 0.15);
@media (prefers-reduced-motion: no-preference) {
    transition: opacity 200ms cubic-bezier(0.3, 0, 0.8, 0.15);
}
}
.shadow-fade-enter-from[data-v-b2df9cce],
.shadow-fade-leave-to[data-v-b2df9cce] {
  opacity: 0;
@media (prefers-reduced-motion: no-preference) {
    scale: 0.9;
}
}
.mt-modal__footer[data-v-b2df9cce] {
  padding: var(--scale-size-24);
  border-top: 1px solid var(--color-border-primary-default);
}
.mt-modal__header[data-v-b2df9cce] {
  padding: var(--scale-size-24);
  border-bottom: 1px solid var(--color-border-primary-default);
  display: flex;
  justify-content: space-between;
...
.mt-modal__header-content[data-v-b2df9cce] {
  display: flex;
  flex-direction: row;
  align-items: baseline;
  column-gap: var(--scale-size-8);
...
@media (hover: hover) {
&[data-v-b2df9cce]:hover {
      background-color: var(--color-interaction-secondary-hover);
}
}
&[data-v-b2df9cce]:focus-visible {
    outline: 2px solid var(--color-border-brand-selected);
    box-shadow: 0 0 4px 0 rgba(24, 158, 255, 0.3);
}
}
...
.mt-icon[data-v-55e6cf87] {
    transition: 0.1s all ease-in-out;
    color: var(--color-text-secondary-default);
}
&:hover .mt-icon[data-v-55e6cf87] {
    color: var(--color-interaction-primary-hover);
}
&.is-active .mt-icon[data-v-55e6cf87] {
    color: var(--color-interaction-primary-pressed);
}
&[data-v-55e6cf87]:disabled {
    cursor: not-allowed;
}
}
.mt-text-editor-toolbar-button:disabled .mt-icon[data-v-55e6cf87] {
  color: var(--color-text-secondary-disabled);
}
...
.mt-url-field--future-remove-default-margin[data-v-a1cfe471] {
  margin-bottom: 0;
}
.mt-url-field__block {
&[data-v-a1cfe471] {
...
&[data-v-a1cfe471]:has(.mt-url-field__input:focus-visible) {
    border-color: var(--color-border-brand-selected);
    box-shadow: 0 0 4px 0 rgba(24, 158, 255, 0.3);
}
&[data-v-a1cfe471]:has(.mt-url-field__input:disabled) {
    background: var(--color-background-primary-disabled);
}
}
.mt-url-field__block--size-default[data-v-a1cfe471] {
  min-height: var(--scale-size-48);
}
.mt-url-field__block--size-small[data-v-a1cfe471] {
  min-height: var(--scale-size-32);
}
.mt-url-field__block--error[data-v-a1cfe471] {
  border-color: var(--color-border-critical-default);
  background: var(--color-background-critical-dark);
}
.mt-url-field__input {
...
&[data-v-a1cfe471]::placeholder {
    color: var(--color-text-secondary-default);
}
}
.mt-url-field__affix[data-v-a1cfe471] {
  display: grid;
  place-items: center;
  height: 100%;
  background: var(--color-interaction-secondary-default);
...
.mt-url-field__affix--disabled[data-v-a1cfe471] {
  background: var(--color-interaction-secondary-disabled);
}
.mt-url-field__affix--prefix[data-v-a1cfe471] {
  border-top-left-radius: var(--border-radius-xs);
  border-bottom-left-radius: var(--border-radius-xs);
  border-right: 1px solid var(--color-border-primary-default);
  font-size: var(--font-size-xs);
...
.mt-url-field__affix--suffix[data-v-a1cfe471] {
  border-top-right-radius: var(--border-radius-xs);
  border-bottom-right-radius: var(--border-radius-xs);
  border-left: 1px solid var(--color-border-primary-default);
  font-size: var(--font-size-2xs);
...
&[data-v-a1cfe471]:focus-visible {
    outline-offset: 4px;
    outline: 2px solid var(--color-border-brand-selected);
    border-radius: var(--border-radius-xs);
}
&[data-v-a1cfe471]:disabled {
    cursor: default;
}
}
...
&[data-v-a1cfe471]:is(:hover, :focus-visible) {
    background-color: var(--color-interaction-secondary-hover);
}
&[data-v-a1cfe471]:focus-visible {
    outline: 2px solid var(--color-border-brand-selected);
...
.mt-url-field__hint[data-v-a1cfe471] {
  grid-area: hint;
  font-family: var(--font-family-body);
  font-size: var(--font-size-xs);
  line-height: var(--font-line-height-xs);
...
.mt-unit-select-result[data-v-a812099d] {
  min-width: 170px;
  padding: var(--scale-size-10) var(--scale-size-16);
  display: grid;
...
.mt-unit-select-result span[data-v-a812099d] {
  color: var(--color-slate-700);
}
.mt-unit-select-result[data-v-a812099d]:hover {
  background-color: var(--color-background-brand-default);
}
.mt-unit-select-result--active[data-v-a812099d] {
  border-radius: var(--border-radius-xs);
  background-color: var(--color-background-brand-default);
}
.mt-unit-select-result--selected span[data-v-a812099d] {
  color: var(--color-text-brand-default);
}

.mt-unit-select[data-v-eeeaf2a6] {
  padding: var(--scale-size-8);
  border: 1px solid var(--color-border-primary-default);
  border-radius: var(--border-radius-button);
  background-color: var(--color-elevation-surface-overlay);
...
.mt-unit-select ul[data-v-eeeaf2a6] {
  list-style: none;
}
.mt-unit-select__trigger[data-v-eeeaf2a6] {
  height: 100%;
  display: grid;
  grid-auto-flow: column;
  align-items: center;
...
.mt-unit-select__trigger[data-v-eeeaf2a6]:disabled {
  background-color: var(--color-background-primary-disabled);
...
a[target=_blank]:not(.mt-internal-link,
.mt-link--external,
.mt-link--internal,
.mt-button) {
  display: inline-block;
